...
export default function FlashSales() {
    ...
    const handleReset = (resetForm: () => void) => {
        // to keep current tab active
        const currentParams = new URLSearchParams(searchParams.toString());
        currentParams.delete('start_at');
        currentParams.delete('end_at');
        // Ensure type remains 'flash_sale'
        currentParams.set('type', 'flash_sale');
    ...
    const { mutate: Delete } = useMutate({
        ...
        onSuccess: async (data: any) => {
            ShowAlertMixin({
                ...
                title:
                    data?.data?.message ||
                    t('isDeletedSuccessfully', { name: t('labels.flash_sale') }),
            });
            refetch();
        },
