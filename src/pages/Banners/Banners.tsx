...
import type { FetchBannersData, Banner } from './types';
...
export default function Banners() {
    ...
    const columns: MRT_ColumnDef<Banner>[] = [
        {
            header: '#',
