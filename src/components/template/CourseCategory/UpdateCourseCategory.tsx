...
export default function UpdateCourseCategory() {
    ...
    const breadcrumbItems = [
        ...
        { label: t('breadcrumb.course_category.edit') },
    ];
    ...
    const { mutate: update, isLoading: LoadingUpdate } = useMutate({
        mutationKey: [`course-category/${id}`],
        endpoint: `course-category/${id}`,
        ...
        onSuccess: (data: any) => {
            ShowAlertMixin({
                ...
                title:
                    data?.data?.message ||
                    t('isEditSuccessfully', { name: t('breadcrumb.course_category.title') }),
            });

            // notify('success');
            refetch();
            navigate('/course-category/index');
        },
        onError: (err: any) => {
            ShowAlertMixin({
                type: 15,
        ...
        <div>
            ...
            >
                {({ validateForm }) => {
                    ...
                    return (
                        <Form>
                            <CourseCategoryMainData isLoading={showDataLoading} />
