...
import ProductFieldArray from './ProductsFieldArray';
import { useParams } from 'react-router-dom';
import DateInput from '../../atoms/DateInput';

export default function MainDataOffer({ isLoading }: { isLoading?: boolean }) {
    ...
    const typesList = [
        {
            id: 0,
            value: 'flash_sale',
            label: t('labels.flash_sale'),
        },
        {
            id: 1,
            value: 'offer',
            label: t('labels.offer'),
        },
    ];
