...
///
export const Loading = ({ mainTitle, subTitle = t('loading').toString() }: LoadingProps_TP) => {
    /////////// VARIABLES
    ///
    ...
    ///
    return (
        <div className="m-auto my-28 flex h-full w-full items-center justify-center absolute z-50 top-[0px] left-0">
